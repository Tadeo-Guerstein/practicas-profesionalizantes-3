/**
 * Tomando la estructura de datos desarrollada en el punto 5.
 * Complétela con información y desarrolle una función que devuelva el conjunto de todos los promedios de todas las temperaturas representadas.
 */
...
const getPromedio = function (array) {
  let sum = 0
  array.forEach((i) => {
    if (i.month !== 'Anual') {
      sum += i.value
...
datosMetereologicos.forEach((i) => {
  console.info('promedio', getPromedio(i))
})
